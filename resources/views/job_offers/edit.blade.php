                ...
                <tbody>
                    ...
                    <tr class="afterRecruit">
                        ...
                        <td>
                            ...
                            <textarea tabindex="-1"  type="text" class="form-control" name="bonuses_treatment">{{ isset($jobOffer->bonuses_treatment) ? $jobOffer->bonuses_treatment : '' }}</textarea>
                            @else
                            <textarea tabindex="-1"  type="text" class="form-control" name="bonuses_treatment">{{ old('bonuses_treatment') }}</textarea>
                            @endif
                        </td>
                    </tr>
                    <tr class="afterRecruit">
                        ...
                        <td>
                            ...
                            <textarea tabindex="-1"  type="text" class="form-control" name="holidays_vacations">{{ isset($jobOffer->holidays_vacations) ? $jobOffer->holidays_vacations : '' }}</textarea>
                            @else
                            <textarea tabindex="-1"  type="text" class="form-control" name="holidays_vacations">{{ old('holidays_vacations') }}</textarea>
                            @endif
                        </td>
                    </tr>
                    <tr class="afterRecruit">
                        ...
                        <td>
                            ...
                            <textarea tabindex="-1"  type="text" class="form-control" name="introduction_others">{{ isset($jobOffer->introduction_others) ? $jobOffer->introduction_others : '' }}</textarea>
                            @else
                            <textarea tabindex="-1"  type="text" class="form-control" name="introduction_others">{{ old('introduction_others') }}</textarea>
                            @endif
                        </td>
                    </tr>
                </tbody>
