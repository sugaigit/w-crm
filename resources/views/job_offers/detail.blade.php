            ...
            <table class="table" style="width: 100%; table-layout: fixed;">
                <tbody>
                    <tr colspan="10">
                        ...
                        <td colspan="4">
                            <input style="pointer-events: none;" tabindex="-1"  type="text" class="form-control" name="job_number" value="{{ $jobOffer->job_number }}">
                        </td>
                    </tr>
                    <tr colspan="10">
                    ...
                    <tbody>
                        ...
                        <tr colspan="10">
                            ...
                            <td colspan="9">
                                ...
                                <textarea style="pointer-events: none;"  rows="5" class="form-control" name="working_hours_remarks"> {{ isset($jobOffer->working_hours_remarks) ? $jobOffer->working_hours_remarks : '' }}</textarea>
                                @else
                    ...
                    <tbody>
                        ...
                        <tr class="afterRecruit" colspan="10">
                            ...
                            <td colspan="9">
                                ...
                                <textarea  style="pointer-events: none;" tabindex="-1"  type="text" class="form-control" name="bonuses_treatment" rows=5>{{ isset($jobOffer->bonuses_treatment) ? $jobOffer->bonuses_treatment : '' }}</textarea>
                                @else
                        ...
                        <tr class="afterRecruit" colspan="10">
                            ...
                            <td colspan="9">
                                ...
                                <textarea  style="pointer-events: none;" tabindex="-1"  type="text" class="form-control" name="holidays_vacations" rows=5>{{ isset($jobOffer->holidays_vacations) ? $jobOffer->holidays_vacations : '' }}</textarea>
                                @else
                        ...
                        <tr class="afterRecruit" colspan="10">
                            ...
                            <td colspan="9">
                                ...
                                <textarea  style="pointer-events: none;" tabindex="-1"  type="text" class="form-control" name="introduction_others" rows=5>{{ isset($jobOffer->introduction_others) ? $jobOffer->introduction_others : '' }}</textarea>
                                @else
