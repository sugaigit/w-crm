        ...
        <div class="card mb-4">
            ...
            <tbody>
                    <tr colspan="10">
                        ...
                        <td colspan="4">
                            <input style="pointer-events: none;" tabindex="-1"  type="text" class="form-control" name="job_number" value="{{ $draftJobOffer->job_number }}">
                        </td>
                    </tr>
                    <tr colspan="10">
                    ...
                    <tr colspan="10">
                        ...
                        <td colspan="4">
                            <select style="pointer-events: none;" tabindex="-1" class="form-control required" name="type_contract" required>
                        ...
                        <td colspan="4">
                            ...
                            <input  style="pointer-events: none;" tabindex="-1" type="text" class="form-control required" name="recruitment_number" value="{{ isset($draftJobOffer->recruitment_number) ? $draftJobOffer->recruitment_number : '' }}" required>
                            @else
                    ...
                    <tr colspan="10">
                        ...
                        <td colspan="9">
                            ...
                            <input  style="pointer-events: none;" tabindex="-1" type="text" class="form-control draft-require" name="company_name" value="{{ isset($draftJobOffer->company_name) ? $draftJobOffer->company_name : '' }}" required>
                            @else
                    ...
                    <tr colspan="10">
                        ...
                        <td colspan="9">
                            ...
                            <input  style="pointer-events: none;" tabindex="-1" type="text" class="form-control required" name="company_address" value="{{ isset($draftJobOffer->company_address) ? $draftJobOffer->company_address : '' }}" required>
                            @else
                    ...
                    <tr colspan="10">
                        ...
                        <td colspan="9">
                            ...
                            <input  style="pointer-events: none;" tabindex="-1" type="text" maxlength="100" class="form-control" name="ordering_business" value="{{ isset($draftJobOffer->ordering_business) ? $draftJobOffer->ordering_business : '' }}" required>
                            @else
                    ...
                    <tr colspan="10">
                        ...
                        <td colspan="9">
                            ...
                            <textarea style="pointer-events: none;" rows="15" class="form-control" name="order_details" required>{{ isset( $draftJobOffer->order_details) ? $draftJobOffer->order_details : '' }}</textarea>
                            @else
                ...
                <tbody>
                    <div class="card-header only-not-introduced">▼請求情報</div>
                        <tr colspan="10">
                            ...
                            <input  style="pointer-events: none;" tabindex="-1" type="text" class="form-control required" name="invoice_unit_price_1" value="{{ isset($draftJobOffer->invoice_unit_price_1) ? $draftJobOffer->invoice_unit_price_1 : '' }}" required>
                            @else
                        ...
                        <tr colspan="10">
                            ...
                            <td colspan="4">
                                ...
                                <input  style="pointer-events: none;" tabindex="-1" type="text" class="form-control required" name="profit_rate_1" value="{{ isset($draftJobOffer->profit_rate_1) ? $draftJobOffer->profit_rate_1 : '' }}" required>
                                @else
                    ...
                    <tbody>
                        ...
                        <tr colspan="10">
                            ...
                            <td colspan="4">
                                ...
                                <input  style="pointer-events: none;" tabindex="-1" type="text" class="form-control required" name="payment_unit_price_1" value="{{ isset($draftJobOffer->payment_unit_price_1) ? $draftJobOffer->payment_unit_price_1 : '' }}" required>
                                @else
                            ...
                            <td colspan="4">
                                <select style="pointer-events: none;" tabindex="-1" type="text" class="form-control" name="payment_unit_2">
                                    ...
                                    @foreach( config('options.salary_term') as $key => $payment_unit_2 )
                                        ...
                                        <option value="{{ $key }}" {{ $key == $draftJobOffer->payment_unit_2 ? 'selected' : '' }}>{{ $payment_unit_2 }}</option>
                                        @else
                            ...
                            <td colspan="4">
                                <select style="pointer-events: none;" tabindex="-1" type="text" class="form-control" name="payment_unit_3">
                                    ...
                                    @foreach( config('options.salary_term') as $key => $payment_unit_3 )
                                        ...
                                        <option value="{{ $key }}" {{ $key == $draftJobOffer->payment_unit_3 ? 'selected' : '' }}>{{ $payment_unit_3 }}</option>
                                        @else
                    ...
                    <tbody>
                            ...
                            <td colspan="9">
                                @foreach(config('options.holiday') as $index => $holiday)
                                    <div class="form-check form-check-inline">
                                        ...
                                        <input  style="pointer-events: none;" tabindex="-1" class="form-check-input required" type="checkbox" id="{{ 'holidayInput' . $index }}" name="holiday[]" value="{{ $index }}" @if(is_array($draftJobOffer->holiday)) {{ in_array($index, $draftJobOffer->holiday) ? 'checked' : '' }} @endif>
                                        @else
                        ...
                        <tr colspan="10">
                            ...
                            <td colspan="9">
                                ...
                                <textarea style="pointer-events: none;" tabindex="-1" type="textarea" rows="1" class="form-control" name="holiday_remarks"> {{ isset($draftJobOffer->holiday_remarks) ? $draftJobOffer->holiday_remarks : '' }}</textarea>
                                @else
                    ...
                    <tbody>
                        ...
                        <tr colspan="10">
                            ...
                            <td colspan="4">
                                ...
                                <input  style="pointer-events: none;" tabindex="-1" type="text" class="form-control required" name="working_hours_1" value="{{ isset($draftJobOffer->working_hours_1) ? $draftJobOffer->working_hours_1 : '' }}" required>
                                @else
                            ...
                            <td colspan="4">
                                ...
                                <input  style="pointer-events: none;" tabindex="-1" type="text" class="form-control required" name="actual_working_hours_1" value="{{ isset($draftJobOffer->actual_working_hours_1) ? $draftJobOffer->actual_working_hours_1 : '' }}" required>
                                @else
                        ...
                        <tr colspan="10">
                            ...
                            <td colspan="4">
                                ...
                                <input  style="pointer-events: none;" tabindex="-1" type="text" class="form-control required" name="break_time_1" value="{{ isset($draftJobOffer->break_time_1) ? $draftJobOffer->break_time_1 : '' }}" required>
                                @else
                        ...
                        <tr colspan="10">
                            ...
                            <td colspan="4">
                                ...
                                <input  style="pointer-events: none;" tabindex="-1"  type="text" class="form-control required" name="overtime" value="{{ isset($draftJobOffer->overtime) ? $draftJobOffer->overtime : '' }}" required>
                                @else
                        ...
                        <tr colspan="10">
                            ...
                            <td colspan="9">
                                ...
                                <textarea style="pointer-events: none;"  rows="5" class="form-control" name="working_hours_remarks"> {{ isset($draftJobOffer->working_hours_remarks) ? $draftJobOffer->working_hours_remarks : '' }}</textarea>
                                @else
                    ...
                    <tbody>
                        ...
                        <tr colspan="10">
                            ...
                            <td colspan="9">
                                ...
                                <textarea rows="5" style="pointer-events: none;" tabindex="-1" class="form-control" name="traffic_commuting_remarks" value="{{ isset($draftJobOffer->traffic_commuting_remarks) ? $draftJobOffer->traffic_commuting_remarks : '' }}"></textarea>
                                @else
                    ...
                    <tbody>
                            ...
                            <td colspan="4">
                                <select style="pointer-events: none;" tabindex="-1" type="text" class="form-control" name="uniform_supply">
                                    ...
                                    @foreach( config('options.uniform_supply') as $key => $uniformSupply )
                                        ...
                                        <option value="{{ $key }}" {{ $key == $draftJobOffer->uniform_supply ? 'selected' : '' }}>{{ $uniformSupply }}</option>
                                        @else
                        ...
                        <tr colspan="10">
                            ...
                            <td colspan="9">
                                ...
                                <textarea style="pointer-events: none;" type="textarea" rows="10" class="form-control" name="remarks_workplace">{{ isset( $draftJobOffer->remarks_workplace) ? $draftJobOffer->remarks_workplace : '' }}</textarea>
                                @else
                        ...
                        <tr class="afterRecruit" colspan="10">
                            ...
                            <td colspan="9">
                                ...
                                <textarea  style="pointer-events: none;" tabindex="-1"  type="text" class="form-control" name="bonuses_treatment" rows=5>{{ isset($draftJobOffer->bonuses_treatment) ? $draftJobOffer->bonuses_treatment : '' }}</textarea>
                                @else
                                <textarea  style="pointer-events: none;" tabindex="-1"  type="text" class="form-control" name="bonuses_treatment" rows=5>{{ old('bonuses_treatment') }}</textarea>
                                @endif
                            </td>
                        </tr>
                        <tr class="afterRecruit" colspan="10">
                            ...
                            <td colspan="9">
                                ...
                                <textarea  style="pointer-events: none;" tabindex="-1"  type="text" class="form-control" name="holidays_vacations" rows=5>{{ isset($draftJobOffer->holidays_vacations) ? $draftJobOffer->holidays_vacations : '' }}</textarea>
                                @else
                                <textarea  style="pointer-events: none;" tabindex="-1"  type="text" class="form-control" name="holidays_vacations" rows=5>{{ old('holidays_vacations') }}</textarea>
                                @endif
                            </td>
                        </tr>
                        <tr class="afterRecruit" colspan="10">
                            ...
                            <td colspan="9">
                                ...
                                <textarea  style="pointer-events: none;" tabindex="-1"  type="text" class="form-control" name="introduction_others" rows=5>{{ isset($draftJobOffer->introduction_others) ? $draftJobOffer->introduction_others : '' }}</textarea>
                                @else
                                <textarea  style="pointer-events: none;" tabindex="-1"  type="text" class="form-control" name="introduction_others" rows=5>{{ old('introduction_others') }}</textarea>
                                @endif
                            </td>
                        </tr>
                    </tbody>
